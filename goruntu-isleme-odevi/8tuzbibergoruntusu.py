...
median_filtered_img = median_filter(img, size=15)  # Filtre boyutu ayarlanabilir
mean_filtered_img = mean_filter(img, size=3)  # Filtre boyutu ayarlanabilir
